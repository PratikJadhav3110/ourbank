...
function validateWithdrawForm(form) {
    ...
    if(!accountno || !username || !password || !amount) {
    ...
    if(!isNaN(username)) {
        alert("User Name must contain characters");
        form.username.focus();
        return false;
    }
...
<tr>
    ...
    <td width="450" valign="top">
        ...
        <form name="F1" onsubmit="return validateWithdrawForm(this)" action="withdraw.jsp" method="post">
    ...
    <td width="299" valign="top">
        ...
        <p>Welcome to Our Bank! Your financial journey starts here. We're dedicated to providing personalized banking solutions and exceptional service to help you achieve your goals.</p>
    </td>
</tr>
</table>
